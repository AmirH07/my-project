    ...
    while (1) { // System Lifetime Loop
        ...
        while (session_active) {
            if (strcmp(current_role, "deputy") == 0) {
                ...
                switch (opt) {
case 1: manage_users_sub_menu(students, &student_count, professors, &professor_count, accounts, &account_count); 
    break;
case 2: 
...
case 3: 
    ...
    break;
case 4: printf("\n[Feature] Manual Student Allocation coming up in Phase 4.2...\n"); break;
case 5: 
    advance_semester_phase(&sysState); 
    break;
                    case 6: printf("\n[Feature] Add Course Capacity coming up in Phase 3.3...\n"); break;
                    case 7: 
...
case 1: 
    ...
    break;
                    case 2: printf("\n[Feature] Capacity Request coming up in Phase 3.3...\n"); break;
                    case 3: printf("\n[Feature] Offering Cancellation coming up in Phase 3.3...\n"); break;
case 4: 
    ...
    break;
                    case 5: printf("\n[Feature] Survey Results coming up in Phase 7.1...\n"); break;
                    case 6: printf("\n[Feature] LMS Module coming up in Phase 7.2...\n"); break;
                    case 7: 
...
case 2: 
    ...
    break;
                    case 3: printf("\n[Feature] Survey Evaluation coming up in Phase 7.1...\n"); break;
                    case 4: printf("\n[Feature] Doctoral Thesis coming up in Phase 5.3...\n"); break;
                    case 5: printf("\n[Feature] LMS Module coming up in Phase 7.2...\n"); break;
                    case 6: 
